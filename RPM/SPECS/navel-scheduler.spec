...
Requires:    perl => 5.10.1-1, perl(Scalar::Util::Numeric), perl(IO::File), perl(File::Slurp), perl(IPC::Cmd), perl(Net::AMQP::RabbitMQ), perl(Carp), perl(EV), perl(AnyEvent::Datetime::Cron), perl(Exporter::Easy), perl(Storable), perl(Data::Validate::Struct), perl(Scalar::Util), perl(DateTime::Event::Cron::Quartz), perl(List::MoreUtils), perl(String::Util), perl(Cwd), perl(Proc::Daemon), perl(Mojolicious)
